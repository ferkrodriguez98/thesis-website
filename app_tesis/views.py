...
def get_catalan_texts():
    extraversion_info = "L'extraversió és una dimensió de la personalitat que descriu el nivell d'interacció d'una persona amb el seu entorn. Les persones extrovertides són sociables, amigables i xerraires, mentre que les persones introvertides són reservades, tranquil·les i discretes."
    ...
    extraversion_score_description = { 
        ...
        'low': "La teva puntuació en extraversió és baixa. Ets capaç de gaudir de la companyia dels altres, però també valores el teu temps a soles. Pots ser tant introvertit com extrovertit en diferents situacions.",
        'medium': "La teva puntuació en extraversió és moderada. Gaudeixes de les interaccions socials, però també valores el teu temps a soles. Et pots adaptar fàcilment a diferents entorns socials.",
